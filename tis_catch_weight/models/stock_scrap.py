...
class StockScrap(models.Model):
    ...
    product_cw_uom = fields.Many2one('product.uom', string='CW-UOM', states={'done': [('readonly', True)]})
    scrap_cw_qty = fields.Float(string='CW Quantity', digits=dp.get_precision('Product CW Unit of Measure'),
